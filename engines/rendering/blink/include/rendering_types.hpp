...
#ifndef NEXUS_BLINK_RENDERING_TYPES_HPP
#define NEXUS_BLINK_RENDERING_TYPES_HPP
...
struct EngineConfiguration {
    ...
    RenderingMode rendering_mode = RenderingMode::Software;
    JavaScriptMode javascript_mode = JavaScriptMode::Sandboxed;
    NetworkAccess network_access = NetworkAccess::Disabled;
    StorageMode storage_mode = StorageMode::Temporary;
